  ...
  async Render() {
    try {
        ...
        const result = await reqJson(
            "https://api.restcountries.com/countries/v5?limit=100&response_fields=names.common,names.official,flag,currencies,population,capitals,region,borders,languages,codes.alpha_2,codes.alpha_3",
            {
                headers: {
                    Authorization: "Bearer rc_live_7bf72076d32b4169a7d6606ac99ed8d6"
                }
            }
        );
